package com.jo.paris.service.mail;
...
public class EmailService {
    ...
    public byte[] generateQRCode(String text, int width, int height) throws WriterException, java.io.IOException {
    ...
    public void sendEmail(User user, Product product) {
        try{
            ...
            helper.setText("<html><body>" +
                    "<p>Hello 👋,</p>" +
                    "<p>Thank you for your purchase! Here is the QR code for your ticket you can scan:</p>" +
                    "<img src='cid:qrCode'>" +
                    "</body></html>", true);
